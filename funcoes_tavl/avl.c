...
/*rotação 1: rot. simples à direita */
...
/*rotação 2: rot. simples à esquerda */
...
/*calcula a altura quando retira um elemento da avl*/
...
/*função auxiliar para imprimir a avl*/
